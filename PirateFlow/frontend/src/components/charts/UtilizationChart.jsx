 ...
 *   mode          — "single" | "multi" | "forecast"
 *   buildingNames — array of building name strings (for multi mode)
 *   height        — chart height (default 260)
 */
export default function UtilizationChart({ data = [], mode = "single", buildingNames = [], height = 260 }) {
  return (
